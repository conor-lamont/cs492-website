        ...
        <Box sx={{ width: '100%', typography: 'body2', color: 'black' }}>
            <div>
                ...
                <p>
                    ...
                    on whether they feel that the platform should publicly provide information on how user data is stored, 90% responded "Yes". In our own investigations, we even saw
                    how there are issues with links Waterloo claims they do provide, but do not. Take <a href='https://uwaterloo.ca/records-management/records-classification-and-retention-schedules/administration'>this</a> site for example -
                    they are supposed to provide information about how contracts are stored - "AD80 – Contracts & Agreements", but the link is dead.
                </p>
                <p>
